...
master['return'] = (master['4. close'] - master['1. open'])/master['1. open']
master['s_return'] = -master['return']
master['constant'] = 1


#isolate day 0 winners and losers
...
tab_win.title = 'Analysis of Gap -25% Winners'
tab_loss.title = 'Analysis of Gap -25% Losers'
